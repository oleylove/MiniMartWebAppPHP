...
<head>
    ...
    <!-- CSS Files -->
    <?php require_once('../layouts/header-css.php'); ?>
...
<body class="g-sidenav-show  bg-gray-100">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex px-2 py-1">
                                                    <div>
                                                        <img src="../images/small-logos/logo-atlassian.svg"
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex px-2 py-1">
                                                    <div>
                                                        <img src="../images/small-logos/logo-invision.svg"
    ...
    <?php 
        ...
        require_once('../layouts/dashboard-js.php'); 
    ?>
